//	Changed table products → product.
//	
//	Changed column product_name → name.
//	
//	Removed invalid role column from users query.
//	
//	Added display of first_name, last_name, city, mobile

package com.smartshop.admin;

import java.sql.*;
//import com.smartshop.core.DBConnection;  // make sure this import exists
...
public class AdminService {
    ...
    public void viewProductStock(int productId) {
        try (Connection con = DBConnection.getConnection()) {
            String query = "SELECT name, quantity FROM product WHERE product_id=?";
    ...
    public void viewRegisteredUsers() {
        try (Connection con = DBConnection.getConnection()) {
            String query = "SELECT user_id, first_name, last_name, username, email, city, mobile FROM users";
